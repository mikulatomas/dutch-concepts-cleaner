...
class Judgements:
    def __init__(self, dataset):
        ...
        self.pairwise_similarity = dcj.PairwiseSimilarityLoader(self).load()

        self.goodness = dcj.GoodnessLoader(self).load()

        self.goodness_rank_order = dcj.GoodnessRankOrderLoader(self).load()
        ...
        ) = dcj.GenerationFrequencyAndAssociativeLoader(self).load()

        self.imageability = dcj.ImageabilityLoader(self).load()

        self.word_frequency = dcj.WordFrequncyLoader(self).load()
